  ...
  programs.rofi = {
    ...
    in {
      "*" = {
        ...
        selected-normal-background = mkLiteral "@common-secondary-33";
        selected-normal-foreground = mkLiteral "@common-secondary-bright";
        selected-normal-border-color = mkLiteral "@common-secondary-66";
